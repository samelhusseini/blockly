 ...
 * @package
 */
Blockly.zelos.PathObject.prototype.positionConnectionIndicator = function(x,
    y) {
  if (!this.svgOutputConnectionIndicator_) {
    ...
    this.svgRoot.insertBefore(this.svgOutputConnectionIndicator_, this.svgPath);
    Blockly.utils.dom.createSvgElement('circle', {'r': 7},
