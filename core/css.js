...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.blocklySearchDiv {',
    ...
    'color: #5F6368;',
    'z-index: 100;', /* search goes above everything else */
  '}',
  '.blocklySearchDiv.visible {',
    'top: 0;',
  '}',

  '.blocklySearchInputWrapper {',
    'width: 170px;',
    'display: inline-block;',
    'user-select: none;',
    'cursor: text;',
  ...
  '.blocklySearchInputWrapper > table {',
  ...
  '.blocklySearchInputWrapper.focused > table {',
    'border: 2px solid #1a73e8;',
    'padding: 0px 7px;',
  '}',

  '.blocklySearchInputWrapper > table > tr > td {',
    'max-width: 120px;',
    'padding: 0 8px 0 4px;',
  '}',

  '.blocklySearchInputCount {',
    'color: #ccc;',
    'white-space: nowrap;',
    'font-size: 14px;',
  '}',
  ...
  '.blocklySearchClose {',
    ...
    'cursor: pointer;',
  '}',
  '.blocklySearchClose:focus {',
    'border-radius: 4px;',
    'border: 2px solid #1a73e8;',
  '}',
  '.blocklySearchClose:hover {',
    'color: #5F6368;',
  '}',
